...
def create_app(name: str = __name__, db_config: dict = {'db': 'homma', 'host': 'mongodb://127.0.0.1:27017/homma'},
               redis_url: str = 'redis://127.0.0.1:6379', testing: bool = False) -> Flask:
